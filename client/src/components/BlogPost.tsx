...
const BlogPostComponent = ({ post }: BlogPostProps) => {
  ...
  return (
    <CleanCard className="p-0 overflow-hidden group">
      <motion.div
      ...
      >
        <div className="grid md:grid-cols-5 gap-0 h-full">
          ...
          <div className="md:col-span-2 h-64 md:h-full relative overflow-hidden border-r border-[var(--border-color)]">
            <div className="absolute inset-0 bg-gradient-to-t from-[var(--bg-body)]/80 to-transparent z-10 md:hidden"></div>
            <img
              src={post.image}
              alt={post.title}
            ...
            <div className="absolute top-4 left-4 z-20">
              <span className="px-3 py-1 rounded-full bg-[var(--bg-body)]/50 backdrop-blur-md border border-[var(--text-primary)]/10 text-[10px] font-bold uppercase tracking-wider text-[hsl(var(--accent))] flex items-center">
          ...
          <div className="md:col-span-3 p-8 flex flex-col justify-between relative">
            ...
            <div>
              ...
              <h2 className="font-mono font-bold text-2xl mb-4 text-[var(--text-primary)] group-hover:text-[hsl(var(--accent))] transition-colors leading-tight">
                {post.title}
              </h2>
